    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 20) {
            ...
            VStack{
                ...
                TextField("Enter email", text: $loginUser.email)
                ...
                SecureField("Password", text: $loginUser.password)
                .keyboardType(.default)
                .padding(.all)
                .background(col)
            }
            if self.isNewUser == true {
                VStack{
                    ...
                    TextField("Enter first name", text: $loginUser.firstname)
                    .keyboardType(.default)
                    .padding(.all)
                    .background(col)
                    HStack{
                    ...
                    TextField("Enter last name", text: $loginUser.lastname)
                    .keyboardType(.default)
                    .padding(.all)
                    .background(col)
                    HStack{
                    ...
                    HStack{
                        TextField("Enter nickname", text: $loginUser.nickname)
                        .keyboardType(.default)
                        .padding(.all)
                        .background(col)
                    }
